...
# Audiovisual Works Survey

## Why Works Need a Separate Axis
...
| Work | Artist | Year | Form | Importance |
|---|---|---:|---|---|
| An Optical Poem | Oskar Fischinger | 1938 | abstract film, visual music | A classic mapping musical structure into abstract image |
| Seeing Sound series | Mary Ellen Bute | 1934-1953 | abstract film, electronic imagery | Early visual music by a woman experimental filmmaker |
| TV Buddha | Nam June Paik | 1974 | video installation | A classic of television, self-observation, and closed circuit |
| S/N | Dumb Type | 1994 | multimedia stage work | Critical AV through body, sound, image, and text |
| The Crossing | Bill Viola | 1996 | video/sound installation | Immersive temporal experience through large-scale image and sound |
| datamatics | Ryoji Ikeda | 2006- | AV live, data art | A representative synchronization of data, noise, electronic sound, and image |
| spectra | Ryoji Ikeda | 2004- | light/sound installation | Sound and light at urban and site-specific scale |
| Momentum | United Visual Artists | 2013 | kinetic light/sound installation | A work that turns space into an instrument through light, sound, and movement |
| Machine Hallucinations | Refik Anadol | 2019- | AI/data art, immersive exhibition | A meeting point between machine learning and AV artwork |

Structured metadata is available in [../data/artworks.yaml](../data/artworks.yaml).

## Connection to the Paper Survey
...
- Visual music: Walter Ruttmann, Hans Richter, Viking Eggeling, Len Lye, Norman McLaren, Jordan Belson, John Whitney
- Expanded cinema / live cinema: Gene Youngblood, live cinema, VJ culture
- Japanese media art: Dumb Type, Ryuichi Sakamoto + Shiro Takatani, YCAM-related works
- Contemporary AV live: Alva Noto, Carsten Nicolai, NONOTAK, 404.zero
- Immersive and urban-scale work: teamLab, United Visual Artists, Ryoji Ikeda, Refik Anadol
